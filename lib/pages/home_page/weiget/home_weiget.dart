          ...
          children: [
            Row(
              ...
              children: [
                Row(
                  children: [
                    Icon(Icons.wine_bar_sharp, color: Colors.white, size: 20.w),
                    SizedBox(width: 3.w),
                    Text(
                      "今日收获",
                      style: TextStyle(
            ...
            Row(
              mainAxisAlignment: MainAxisAlignment.spaceAround,
              children: [
                _buildStatItem("5", "总数量", TColor.secondaryCardSmall),
                SizedBox(width: 10.w),
                _buildStatItem("2.8", "总重量(kg)", TColor.secondaryCardSmall),
                SizedBox(width: 10.w),
                _buildStatItem("2", "时长(h)", TColor.secondaryCardSmall),
              ],
            ),
          ],
        ),
