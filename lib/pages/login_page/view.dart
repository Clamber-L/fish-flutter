      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            Center(
              child: CircleAvatar(
                ...
                backgroundImage: AssetImage(
                  'assets/img/app_logo.jpg', // 请确保路径正确
                ),
              ),
            ),
            ...
            Row(
              children: [
                Obx(() => Checkbox(value: state.isAgreeProtocol.value, onChanged: (value) => logic.toggleAgreeProtocol(), activeColor: Colors.blueAccent)),
                Expanded(
                  child: Wrap(
                    children: [
                      Text('我已阅读并同意', style: TextStyle(fontSize: 12.sp, color: Colors.black)),
                      GestureDetector(onTap: () => logic.showUserAgreement(), child: Text('《用户协议》', style: TextStyle(fontSize: 12.sp, color: Colors.blue))),
                      Text('和', style: TextStyle(fontSize: 12.sp, color: Colors.black)),
                      GestureDetector(onTap: () => logic.showPrivacyPolicy(), child: Text('《隐私政策》', style: TextStyle(fontSize: 12.sp, color: Colors.blue))),
                    ],
                  ),
                ),
              ],
            ...
            Center(
              child: Column(
                children: [
                  IconButton(icon: Image.asset('assets/img/wechat.png', width: 48.w, height: 48.h), onPressed: logic.loginWithWeChat),
                  // SizedBox(height: 8.h),
